...
export default function SchaedenClient({ initialReports }: { initialReports: DamageReport[] }) {
  // Startwert server-gerendert (SSR) → sofort im ersten Paint.
  ...
  useEffect(() => {
    // SSR liefert die Meldungen im ersten Paint → nur nachladen, wenn leer.
    if (initialReports.length === 0) fetchReports();
