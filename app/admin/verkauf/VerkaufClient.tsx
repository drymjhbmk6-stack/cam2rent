...
export default function VerkaufClient({ initialSales }: { initialSales: Sale[] }) {
  ...
  useEffect(() => {
    // SSR liefert die Verkäufe im ersten Paint → nur nachladen, wenn leer.
    if (initialSales.length === 0) load();
