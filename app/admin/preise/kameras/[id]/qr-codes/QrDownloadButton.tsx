      ...
      if (isIOS) {
        ...
        if (newTab) {
          newTab.document.write(`
            ...
            <style>body{margin:0;background:#000;display:flex;align-items:center;justify-content:center;min-height:100vh;font-family:-apple-system,sans-serif}img{max-width:90vw;max-height:80vh;background:#fff;padding:16px;border-radius:12px}p{color:#fff;text-align:center;font-size:14px;margin-top:16px;padding:0 24px}</style>
            </head><body>
