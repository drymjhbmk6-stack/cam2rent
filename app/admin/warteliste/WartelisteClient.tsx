...
export default function WartelisteClient({ initialEntries }: { initialEntries: WaitlistEntry[] }) {
  // Startwert kommt server-gerendert (SSR) → sofort im ersten Paint.
  ...
  useEffect(() => {
    // SSR liefert die Einträge im ersten Paint → nur nachladen, wenn leer.
