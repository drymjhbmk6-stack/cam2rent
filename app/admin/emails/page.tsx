...
const TYPE_LABELS: Record<string, { label: string; color: string; bg: string }> = {
  ...
  appointment_confirmation: { label: 'Terminbestätigung', color: '#16a34a', bg: '#16a34a14' },
  ...
  return_follow_up_reminder: { label: 'Erinnerung: Nachsendung offener Teile', color: '#f59e0b', bg: '#f59e0b14' },
...
const TYPE_FILTER_GROUPS: { label: string; options: { label: string; value: string }[] }[] = [
  {
    ...
    options: [
      ...
      { label: 'Terminbestätigung', value: 'appointment_confirmation' },
