      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <section className="mb-10">
          ...
          <div className="space-y-3">
            <div className="bg-brand-bg rounded-card p-4 border-l-4 border-status-success">
              <p className="font-body font-semibold text-brand-black mb-1">
            ...
            <div className="bg-brand-bg rounded-card p-4 border-l-4 border-accent-amber">
              <p className="font-body font-semibold text-brand-black mb-1">
            ...
            <div className="bg-brand-bg rounded-card p-4 border-l-4 border-status-error">
              <p className="font-body font-semibold text-brand-black mb-1">
          ...
          <p className="font-body text-brand-steel mt-4">
