 ...
 * Es wird der Bruttobetrag aus stripe_transactions importiert (z.B. 0,87 €),
 * unabhängig davon ob die Zahlung später rückerstattet wurde.
 * Die Gebühren-Gutschrift bei Rückerstattungen (z.B. 0,36 €) ist so gering,
 * dass sie für die EÜR vernachlässigt wird.
 */
export async function POST(req: NextRequest) {
  ...
  // Zahlungsgebühren aus stripe_transactions (Bruttobetrag)
