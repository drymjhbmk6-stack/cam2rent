  ...
  return (
    <div className="min-h-screen bg-white dark:bg-brand-black">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <h1 className="font-heading font-bold text-3xl text-brand-black dark:text-white mb-2">Datenschutzerklärung</h1>
        <p className="text-sm font-body text-brand-muted dark:text-gray-400 mb-10">Stand: April 2026</p>
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc list-inside font-body text-brand-steel dark:text-gray-300 mt-2 space-y-1">
        ...
        <section className="mb-10">
          ...
          <p className="font-body text-brand-steel dark:text-gray-300 mb-3">
            ...
            notwendige Cookies ein (z.B. <code className="bg-brand-bg dark:bg-brand-dark px-1 rounded text-sm">__stripe_mid</code>,{' '}
            <code className="bg-brand-bg dark:bg-brand-dark px-1 rounded text-sm">__stripe_sid</code>). Diese Cookies sind für
        ...
        <section className="mb-10">
          ...
          <p className="font-body text-brand-steel dark:text-gray-300 mb-3">Erfasst werden ausschließlich:</p>
          <ul className="list-disc list-inside font-body text-brand-steel dark:text-gray-300 space-y-1">
          ...
          <p className="font-body text-brand-steel dark:text-gray-300 mt-3 mb-3">
        ...
        <section className="mb-10">
          ...
          <div className="font-body text-brand-steel dark:text-gray-300 space-y-1">
            <p className="font-semibold text-brand-black dark:text-white">Berliner Beauftragte für Datenschutz und Informationsfreiheit</p>
