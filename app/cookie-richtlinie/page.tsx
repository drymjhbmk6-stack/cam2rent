            ...
            <table className="w-full text-sm font-body">
              <thead>
                <tr className="border-b border-brand-border dark:border-white/10">
                  <th className="text-left py-2 px-3 font-semibold text-brand-black dark:text-white">Name</th>
                  <th className="text-left py-2 px-3 font-semibold text-brand-black dark:text-white">Typ</th>
                  <th className="text-left py-2 px-3 font-semibold text-brand-black dark:text-white">Zweck</th>
                  <th className="text-left py-2 px-3 font-semibold text-brand-black dark:text-white">Dauer</th>
                </tr>
              </thead>
              <tbody className="text-brand-steel dark:text-gray-300">
                <tr className="border-b border-brand-border/50 dark:border-white/10">
                  <td className="py-2 px-3"><code className="bg-brand-bg dark:bg-brand-dark px-1 rounded text-xs">cam2rent_consent</code></td>
                ...
                <tr className="border-b border-brand-border/50 dark:border-white/10">
                  <td className="py-2 px-3"><code className="bg-brand-bg dark:bg-brand-dark px-1 rounded text-xs">cam2rent_cart</code></td>
                  <td className="py-2 px-3">localStorage</td>
                  <td className="py-2 px-3">Warenkorb-Inhalt</td>
                  <td className="py-2 px-3">Dauerhaft</td>
                </tr>
                <tr className="border-b border-brand-border/50 dark:border-white/10">
                  <td className="py-2 px-3"><code className="bg-brand-bg dark:bg-brand-dark px-1 rounded text-xs">sb-*-auth-token</code></td>
                  <td className="py-2 px-3">Cookie</td>
                  <td className="py-2 px-3">Anmeldesitzung (Kundenkonto)</td>
                  <td className="py-2 px-3">Sitzung</td>
                </tr>
                <tr className="border-b border-brand-border/50 dark:border-white/10">
                  <td className="py-2 px-3"><code className="bg-brand-bg dark:bg-brand-dark px-1 rounded text-xs">admin_token</code></td>
                  <td className="py-2 px-3">Cookie</td>
        ...
        <section className="mb-10">
          ...
          <div className="overflow-x-auto -mx-4 sm:mx-0">
            <table className="w-full text-sm font-body">
              ...
              <tbody className="text-brand-steel dark:text-gray-300">
                <tr className="border-b border-brand-border/50 dark:border-white/10">
                  <td className="py-2 px-3"><code className="bg-brand-bg dark:bg-brand-dark px-1 rounded text-xs">__stripe_mid</code></td>
                  <td className="py-2 px-3">Betrugsprävention (Geräte-Identifikation)</td>
                  <td className="py-2 px-3">1 Jahr</td>
                </tr>
                <tr className="border-b border-brand-border/50 dark:border-white/10">
                  <td className="py-2 px-3"><code className="bg-brand-bg dark:bg-brand-dark px-1 rounded text-xs">__stripe_sid</code></td>
          ...
          <p className="font-body text-brand-steel dark:text-gray-300 mt-3 text-sm">
        ...
        <section className="mb-10">
          ...
          <div className="overflow-x-auto -mx-4 sm:mx-0">
            <table className="w-full text-sm font-body">
              ...
              <tbody className="text-brand-steel dark:text-gray-300">
                <tr className="border-b border-brand-border/50 dark:border-white/10">
                  <td className="py-2 px-3"><code className="bg-brand-bg dark:bg-brand-dark px-1 rounded text-xs">cam2rent_vid</code></td>
                  <td className="py-2 px-3">Anonyme Besucher-ID (zufällige UUID)</td>
                  <td className="py-2 px-3">Dauerhaft</td>
                </tr>
                <tr className="border-b border-brand-border/50 dark:border-white/10">
                  <td className="py-2 px-3"><code className="bg-brand-bg dark:bg-brand-dark px-1 rounded text-xs">cam2rent_sid</code></td>
