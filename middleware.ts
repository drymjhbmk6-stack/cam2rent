...
const PATH_PERMISSIONS: PermRule[] = [
  ...
  { prefix: '/admin/reservierungen', perm: 'tagesgeschaeft' },
  { prefix: '/admin/preisrechner', perm: 'tagesgeschaeft' },
  ...
  { prefix: '/admin/sendungen', perm: 'tagesgeschaeft' },
  ...
  { prefix: '/admin/verbrauch', perm: 'katalog' },
  ...
  { prefix: '/admin/content', perm: 'content' },
...
const API_PATH_PERMISSIONS: PermRule[] = [
  ...
  { prefix: '/api/admin/reservierung', perm: 'tagesgeschaeft' },
  { prefix: '/api/admin/preis-check', perm: 'tagesgeschaeft' },
  ...
  { prefix: '/api/admin/sendungen', perm: 'tagesgeschaeft' },
  ...
  { prefix: '/api/admin/verkauf', perm: 'tagesgeschaeft' },
  ...
  { prefix: '/api/admin/combined-labels', perm: 'tagesgeschaeft' },
  ...
  { prefix: '/api/admin/send-verification-reminder', perm: 'kunden' },
  { prefix: '/api/admin/id-document-url', perm: 'kunden' },
  { prefix: '/api/admin/damage-photo-url', perm: 'tagesgeschaeft' },
  { prefix: '/api/admin/damage-attachment-url', perm: 'tagesgeschaeft' },
  ...
  { prefix: '/api/admin/accessory-part-images', perm: 'katalog' },
  ...
  { prefix: '/api/admin/verbrauch', perm: 'katalog' },
  // Rabatte & Aktionen
