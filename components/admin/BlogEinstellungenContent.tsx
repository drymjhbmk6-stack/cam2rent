...
/**
 * Blog-KI-Einstellungen — wird in /admin/einstellungen?tab=blog-ki geladen.
 * Frueher die komplette /admin/blog/einstellungen-Seite.
 */
export default function BlogEinstellungenContent() {
