...
--
-- HARTE ABHAENGIGKEIT: setzt voraus, dass die Legacy-`purchases`-Tabelle
-- existiert. Wurde sie nie angelegt (DBs, die nie die Alt-Buchhaltung
-- hatten), wird die Migration still uebersprungen — purchase_attachments
-- macht ohne purchases keinen Sinn.
...
BEGIN
  IF NOT EXISTS (
    ...
    RAISE NOTICE 'Skip purchase_attachments: Tabelle purchases existiert nicht.';
    RETURN;
  END IF;
