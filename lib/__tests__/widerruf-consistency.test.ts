...
const VERSICHERUNG_ALLOWLIST: Record<string, string> = {
  ...
  'app/admin/buchhaltung/components/FixkostenTab.tsx': 'Fixkosten: Kategorie-Vorschlag „Versicherung" (Betriebsausgabe)',
  ...
  'lib/buchhaltung/euer-data.ts': 'EÜR-Rechenkern: Kategorie-Label (aus der euer-Route extrahiert)',
