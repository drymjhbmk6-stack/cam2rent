...
export function getParagraphen(eigenbeteiligung: number = 200): { title: string; text: string }[] {
  ...
  { title: '\u00a7 13 Widerrufsrecht', text: '(1) Der Mieter als Verbraucher hat ein gesetzliches Widerrufsrecht nach \u00a7\u00a7 355 ff. BGB. Einzelheiten ergeben sich aus der separat zur Verf\u00fcgung gestellten Widerrufsbelehrung.\n(2) Bei Beginn der Dienstleistung vor Ablauf der 14-t\u00e4gigen Widerrufsfrist hat der Mieter ausdr\u00fccklich verlangt, dass der Vermieter mit der Ausf\u00fchrung der Dienstleistung (Versand/Bereitstellung der Mietger\u00e4te) beginnt, und best\u00e4tigt seine Kenntnis davon, dass er mit vollst\u00e4ndiger Vertragserf\u00fcllung durch den Vermieter sein Widerrufsrecht verliert (\u00a7 356 Abs. 4 BGB). Eine Kopie dieser Erkl\u00e4rung einschlie\u00dflich Datum und Uhrzeit ist Bestandteil der Buchungsbest\u00e4tigung.' },
